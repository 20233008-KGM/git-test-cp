...
### 2026-06-09 18:00:00 — 웹프로그래밍 실습 신규 수업 DB 등록

| 항목 | 내용 |
|------|------|
| **계획** | (채팅 요청) 교수 미배정 active 수업 생성 |
| **한 일** | `catalog-web-practice-2026-2` · `course-web-practice-2026-2-2026-2` INSERT, 기본 스테이지 5개, `instructor_user_id`·`professor` NULL |
| **당신이 할 일** | 없음 |

### 2026-06-09 16:45:00 — vision #170~#172 교수 수업 카드·alert·프로필 사진 (260609-2)

| 항목 | 내용 |
|------|------|
| **계획** | [`260609-2.md`](../for_agent/plans/260609-2.md) |
| **#170** | `cc-course-card--other-instructor` · 「다른 교수 담당」 배지 |
| **#171** | catalog/내 강의 입장 시 `alert` (배너 대신) |
| **#172** | `ProfessorProfilePage` 사진 변경 · `api.myPage.updateAvatar` |
| **검증** | `npm run build` 통과 |

### 2026-06-09 14:30:00 — vision #164~#169 회고록·마이페이지·피드백 (260609-1)

| 항목 | 내용 |
|------|------|
| **계획** | [`260609-1.md`](../for_agent/plans/260609-1.md) |
| **범위** | 회고록 자동연동 · 내가 한 경험 · 평가→피드백 · 저장 UX · 산출물 예시 |
| **배포** | commit `143922b9` · https://git-test-cp.vercel.app |

### 2026-05-26 — AI 기능 인간용 문서 전면 갱신

| 항목 | 내용 |
|------|------|
| **문서** | `11_ai_system_explained.md` — 3가지 AI 기능·Mermaid 구조·파일 지도·데이터 흐름·ZIP/기억·폴백 FAQ |
| **문서** | `30_edge_ai_report.md` — `recommend-troubleshooting` 배포·진행 요약 확인 절 추가 |
| **문서** | `10_ai_system.md` (agent) · `00_start_here` AI 읽기 경로 갱신 |

### 2026-05-26 21:55:00 — vision #161~#163 수업 생성·교수 그리드 (260526-8)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-8.md`](../for_agent/plans/260526-8.md) |
| **#161** | 수업 생성 성공 시 모달 즉시 닫기·이중 제출 방지 |
| **#162** | 스테이지 `ai_course_stages` 저장·수업별 조회(글로벌 대체 제거) |
| **#163** | 수강자들 페이지 교수 카드 그리드 배치 |

### 2026-05-26 21:50:00 — vision #160 수업 시작·종료일 (260526-7)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-7.md`](../for_agent/plans/260526-7.md) |
| **DB** | MCP `ai_courses_start_end_dates` — `start_date`·`end_date` |
| **UI** | 수업 생성 모달 시작/종료일 · 강의 시간 텍스트 · 카드·상세 기간 표시 |

### 2026-05-26 21:45:00 — vision #157·#158·#159 배너·네비 인박스 (260526-6)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-6.md`](../for_agent/plans/260526-6.md) |
| **#157** | 산출물 최신 링크 배너가 Storage가 아닌 배포 URL 표시 |
| **#158·#159** | 프로필 빨간 점멸·hover 미확인 공지·DM 목록 (localStorage 읽음) |

### 2026-05-26 15:05:00 — vision #155·#156 폴더 산출물 (260526-5)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-5.md`](../for_agent/plans/260526-5.md) |
| **#155** | 폴더 묶기 중 Gemini 로딩 오버레이·% 진행 |
| **#156** | STORE 무압축 · 배치 yield |

### 2026-05-26 14:10:00 — 반응형·PageHeader·토큰 (260526-4)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-4.md`](../for_agent/plans/260526-4.md) |
| **반응형** | QnA·QnA상세·타학생프로필 `cc-app-shell` |
| **UI** | CourseDetail·StudentsNetwork `PageHeader` · DM 링크/버튼 토큰 |

### 2026-05-26 12:05:00 — vision #154 챗리스트 스레드 오류 (260526-3)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-3.md`](../for_agent/plans/260526-3.md) |
| **#154** | 1:1 peer 검증을 수업 구성원(교수·멤버십 전 역할)으로 확장 |
| **UX** | warm 실패가 메시지 로드 에러를 덮지 않도록 분리 |

### 2026-05-26 11:15:00 — 채팅 전송 API 경량화 (260526-2)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-2.md`](../for_agent/plans/260526-2.md) |
| **캐시** | currentUser·수업·멤버십·peer 목록 세션 캐시 |
| **warm** | 채팅 열 때 검증 1회 → send는 INSERT 위주 |
| **팀** | sort_order MAX SELECT 제거 (`Date.now()`) |

### 2026-05-26 10:10:00 — vision #143·#151·#153 (260526-1)

| 항목 | 내용 |
|------|------|
| **계획** | [`260526-1.md`](../for_agent/plans/260526-1.md) |
| **#153** | 로그인 버튼 `py-3` 패딩 |
| **#143** | Realtime publication 6테이블 · debounced reload hook |
| **#151** | 레이아웃 overflow·min-w-0 |

### 2026-05-25 23:05:00 — vision #140~#148·#144 (260525-12)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-12.md`](../for_agent/plans/260525-12.md) |
| **#140** | 챗리스트 페이지·`useDirectChat`·`listThreads` |
| **#141** | 수강자 페이지 담당 교수 카드 |
| **#142** | 팀플 스테이지 교수 편집 |
| **#144** | 교수 프로필 bio |
| **#147~148** | 조원평가 키워드·기여도 DB·UI |

### 2026-05-25 22:20:00 — vision #134~#152 일괄 (260525-11)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-11.md`](../for_agent/plans/260525-11.md) |
| **완료** | #134~139·#145~146·#149~150·#152 — 로그인 UI·링크 배너·팀명 저장·공지 상세·랜덤팀·무압축 ZIP·수업 삭제·리포트 모달·교수 산출물 차단 |
| **보류** | #140~#144·#147~#148·#151 — 대형 UI·평가 스키마·반응형 |

### 2026-05-25 21:35:00 — vision #131~#133 (260525-10)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-10.md`](../for_agent/plans/260525-10.md) |
| **#132** | Edge 소스 스니펫·다음 할 일·아키텍처·개선 UI · 재배포 |
| **#133** | 산출물 게시판 최상단 최신 링크 배너 |
| **#131** | 수업 등록 hover (#130 동일 클래스) |

### 2026-05-25 21:05:00 — vision #118·반응형·Edge (260525-9)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-9.md`](../for_agent/plans/260525-9.md) |
| **DB** | MCP `performance_fk_indexes` — 팀상세·공지·Q&A FK 인덱스 |
| **Edge** | `recommend-troubleshooting` 재배포 (progress-insight) |
| **UI** | `MainLayout` 내 팀 라벨 truncate · `theme.css` `overflow-x: clip` |

### 2026-05-25 20:20:00 — vision #130 (260525-8)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-8.md`](../for_agent/plans/260525-8.md) |
| **구현** | `cc-courses-join-submit` hover·active 스타일 · 빈 목록 join 버튼 동일 클래스 |
| **doc** | `29` §#130 · `vision_snapshot` |

### 2026-05-25 19:45:00 — vision #126~#129 (260525-7)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-7.md`](../for_agent/plans/260525-7.md) |
| **구현** | 회원가입 비밀번호 안내 · 산출물 최신 링크 배너 · AI 인사이트 중복 제거·Edge 품질 |
| **doc** | `29` §#126~129 |

### 2026-05-25 18:00:00 — vision #122~#125 (260525-6)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-6.md`](../for_agent/plans/260525-6.md) |
| **구현** | 수업 등록 버튼·input 정렬 · 산출물 모달 필드 순서 · AI 진행요약 shimmer/인사이트(Edge+폴백) |
| **doc** | `29` §#122~125 |

### 2026-05-25 16:30:00 — vision #117~#121 (starter 점검)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-5.md`](../for_agent/plans/260525-5.md) |
| **구현** | 마이페이지 교수·관리자 대시보드 · 공지 목록/작성/상세 · 동료평가 레이아웃 |
| **doc** | `29` §#117~122 · C-260525-7 |

### 2026-05-25 — 교수 공지 등록 RLS 수정 (#87)

| 항목 | 내용 |
|------|------|
| **원인** | `ai_announcements` RLS ON · SELECT만 있어 INSERT 거부 |
| **조치** | MCP `ai_announcements_insert_policy` · `formatAnnouncementDbError` |

### 2026-05-25 — DB 업무 MCP 자동화 doc 정본 (`33`)

| 항목 | 내용 |
|------|------|
| **doc** | `33_supabase_mcp_db_operations.md` 신설 · `starter`·`23`·`09`·`28`·`25`·`29_supabase_bundle`·`00` 반영 |
| **규칙** | DDL·Storage → AI MCP · 인간 MCP 연결만 · 일반 DB용 H-xxx 금지 |
...
| 항목 | 내용 |
|------|------|
| **계획** | [`260525-4.md`](../for_agent/plans/260525-4.md) |
| **구현** | 팀 생성 미배정 검증(#107) · 팀 관리 탈퇴 링크(#52) · 스크롤 배경(#97) · 1:1 채팅 SQL 안내(#115) |
| **인간** | H-012 · `apply-remote-full` 후 채팅·산출물 확인 |

### 2026-05-25 15:10:00 — vision #87·#95·#103·#113 잔여

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-3.md`](../for_agent/plans/260525-3.md) |
| **구현** | 공지 API assert 분리(#87) · 조원평가 teammate roster id(#113) · 산출물 URL·Storage 오류(#103·#116) · 프로젝트 평가 팀 DB 요약(#95) |
| **인간** | H-012 후 산출물·강의자료 수동 확인 · #89 Edge 재배포 |

### 2026-05-25 14:43:26 — vision #89·#94·#95·#97·#110·#102

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-2.md`](../for_agent/plans/260525-2.md) |
| **구현** | AI TS 문제만 진단 · 교수 학생평가 user_id · 프로젝트 평가 힌트 · 레이아웃 흰바탕 · 랜덤 팀 인원 입력 · 팀장 넘기기 검증 |
| **doc** | `29` §#85~#116 추가 |

### 2026-05-25 14:31:57 — vision #85~#116 (코드 가능 분)

| 항목 | 내용 |
|------|------|
| **계획** | [`260525-1.md`](../for_agent/plans/260525-1.md) |
| **구현** | `ai_direct_messages`·`DirectChatModal` (#85·#115) · 교수 네비 조원평가 숨김 (#86·#96) · 피드백 UX (#98~#100·#104) · 팀 탈퇴·빈팀삭제·랜덤신규팀 (#101·#108·#111·#112) · 워크스페이스 탈퇴 제거·새팀 숨김 (#105·#106) · 팀장 팀명 수정 (#109) · 매너온도 (#91) · 교수 MP (#92·#114) · 아카이브 조원평가 작성 링크 (#113) |
| **인간** | H-012 SQL 후 #83·#93 강의자료 · `npm run supabase:apply-remote-full` 로 1:1 채팅 테이블 |

### 2026-05-23 21:08:00 — vision #83·#84

| 항목 | 내용 |
|------|------|
| **계획** | [`260523-4.md`](../for_agent/plans/260523-4.md) |
| **구현** | T-203 교수 `MyTeamSideNavGroup` 제거 · T-204 `ai_course_materials` Storage·RLS · `build-apply-remote-full` 갱신 · 업로드 오류 메시지 |
| **인간** | H-012 원격 SQL 적용 후 강의자료 업로드 확인 |

### 2026-05-23 21:00:00 — vision #81·#82·#80 완료

| 항목 | 내용 |
|------|------|
| **계획** | [`260523-3.md`](../for_agent/plans/260523-3.md) |
| **구현** | T-200 `UserAvatar` 카카오 스타일 · T-201 `cc-courses-join-row` · T-202 `AppModal` 전역(채팅·평가·피드백·동료평가·회고·수업생성·마이페이지·수강자 네트워크) |
| **빌드** | `npm run build` 통과 |

### 2026-05-23 20:52:23 — vision #60~#75·#67 2차 (C-260523-2)

| 항목 | 내용 |
|------|------|
| **계획** | [`260523-2.md`](../for_agent/plans/260523-2.md) |
| **한 일** | 강의 자료 업로드(#60)·팀카드 알림(#67)·산출물 통합·상세(#72·#73)·TS 모달·디자인(#74·#75)·업로드 UX(#71) |
| **검증** | `npm run build` pass |
| **당신이 할 일** | 마이그레이션 SQL 적용 후 강의 자료 업로드·산출물 클릭 상세 확인 |

---

### 2026-05-23 20:48:22 — vision #60~#80 1차 (인간 없이 가능 항목)

| 항목 | 내용 |
|------|------|
| **계획** | [`260523-1.md`](../for_agent/plans/260523-1.md) |
| **한 일** | 피드백 버튼 복구(#70)·팀/내팀 네비(#69)·스크롤 상단(#64)·기본 아바타(#63)·팀 활동(#77)·AppModal(#68)·로딩·AI요약 shimmer(#62·#79) |
| **검증** | `npm run build` pass · `npm run vision:snapshot` |
| **당신이 할 일** | 팀 WS 피드백·팀카드 활동·새 팀 모달 위치 확인 |

---

### 2026-05-22 — AI 생성 중 Gemini 무지개 shimmer (C-260522-56)

| 항목 | 내용 |
|------|------|
| **한 일** | `AiGeneratingIndicator`·`cc-gemini-*` CSS — `MyPage` 리포트·`TeamDetailPage` 트러블슈팅 AI 추천 로딩 |
| **검증** | `npm run build` pass |
| **당신이 할 일** | 마이페이지·팀 워크스페이스에서 AI 호출 시 무지개 애니메이션 확인 |

---

### 2026-05-22 23:30:00 — doc 최신화 (C-260522-55)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-48.md`](../for_agent/plans/260522-48.md) |
| **한 일** | `01`·`02`·`05`(T-184)·`08`·`17`·`26`·`27`·`12`·`18`·`29` §대화창 C-55 — vision #56~59·`/mypage/profile`·~84% 동기화 |
| **당신이 할 일** | 없음 |

---

### 2026-05-22 — H-005 프로덕션 배포 완료

| 항목 | 내용 |
|------|------|
| **한 일** | 사용자 「H-005 완료」 확인 — `vercel --prod` Production · **https://git-test-cp.vercel.app** |
| **당신이 할 일** | 배포 URL에서 로그인·수업·팀 스모크. RLS(H-001)·법무(H-006)는 별도 |

---

### 2026-05-22 23:00:00 — vision #56~59 (starter 점검 · `260522-47`)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-47.md`](../for_agent/plans/260522-47.md) |
| **근거** | vision.md 추가요청 #56~59 (§상세, C-ID 없음) |
| **한 일** | 프로필 폼 여백 · 이메일 안내 삭제 · 수강자들→`/mypage/profile` · 로그인 푸터 제거 |
| **검증** | `npm run build` pass |

---

### 2026-05-22 22:30:00 — `29` 기록 분류 지침 개선 (C-260522-54)

| 항목 | 내용 |
|------|------|
| **한 일** | `C-52~53` §대화창에서 제거 → vision §상세 #30·#25·#7로 이전 · `chat_request_recording` §0 · `29`·`23`·`26`·`starter` |
| **당신이 할 일** | 없음 |

---

### 2026-05-22 22:15:00 — starter·vision 점검 후 AI 선행 (`260522-46`, vision #30·#25)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-46.md`](../for_agent/plans/260522-46.md) |
| **근거** | `starter.txt`·`02`·`32` (C-ID 없음) · vision **#30** #25 **#7** 보완 |
| **한 일** | `/app/mypage/profile` · `ai_users.school` MCP · 교수 평가 모달 반응형 · `npm run build` pass |
| **채팅 연동** | 같은 세션 이전 턴 → `C-260522-50`·`51` §대화창 (로그인 카드·교수 팀멤버) |
| **인간** | H-001·H-004~006 미변 |

---

### 2026-05-22 — 채팅: 로그인 카드·교수 팀멤버 (C-260522-50~51)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-46.md`](../for_agent/plans/260522-46.md) |
| **한 일** | `LandingPage`·`SignInPage` 장식 카드 제거 · 교수 「나의 팀 멤버」「팀 관리」 숨김 |
| **기록** | `29` §대화창 `C-260522-50`·`51` |

---

### 2026-05-22 — doc 최신화 (C-260522-49)

### 2026-05-22 — doc 최신화 (C-260522-49)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-45.md`](../for_agent/plans/260522-45.md) |
| **한 일** | C-260522-45~48 반영 · `02`·`12`·`08`·`18`·`01` 갱신 |

---

### 2026-05-22 — 수강자들 「내 프로필 보기」제거 (C-260522-48)

| 항목 | 내용 |
|------|------|
| **한 일** | 본인 카드 상단 버튼 제거 · 카드 클릭 모달·「내 정보 수정」유지 |
| **파일** | `StudentsNetworkPage.tsx` |

---

### 2026-05-22 — 수업코드 타이포 (C-260522-47)

| 항목 | 내용 |
|------|------|
| **한 일** | 모노·굵은 글씨 → `cc-course-code` (sans 400, letter-spacing) · 상세 뱃지 동일 |
| **파일** | `cc-colors.css` · `CourseListCard.tsx` · `CourseDetailPage.tsx` |

---

### 2026-05-22 — 마이페이지 내 정보 탭 UX (C-260522-46)

| 항목 | 내용 |
|------|------|
| **한 일** | 편집 가능 필드 `cc-input` · 학번·이메일·학교 `readOnly`+「변경 불가」 · `?tab=profile` 시 하단 「학생 계정 전용」블록 숨김 |
| **파일** | `MyPage.tsx` · `cc-colors.css` |

---

### 2026-05-22 — 마이페이지 내 정보 통합 (C-260522-45)

| 항목 | 내용 |
|------|------|
| **한 일** | 사이드 「리포트」「내 정보」만 · 내 정보에서 전 필드 표시+저장 · 리포트 탭에서만 AI 리포트 |
| **URL** | `/app/mypage?tab=profile` |
| **파일** | `MyPage.tsx` · `core-flows.spec.ts` #34 |

---

### 2026-05-22 — doc 최신화 (C-260522-44)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-40.md`](../for_agent/plans/260522-40.md) |
| **한 일** | C-260522-40~43 반영 · `02`·`12`·`08`·`01` 갱신 |
| **당신이 할 일** | 프로덕션(https://git-test-cp.vercel.app)에서 아래 항목 확인 |

---

### 2026-05-22 — 프로덕션 배포 (C-260522-43)

| 항목 | 내용 |
|------|------|
| **한 일** | `git add .` · commit `994e9480` 「260522-2 디자인 수정」(65 files) · `origin/구현중` push · `vercel --prod` 성공 |
| **URL** | https://git-test-cp.vercel.app · https://git-test-pwhiuacx8-awesome-s-projects1.vercel.app |
| **당신이 할 일** | 배포 URL에서 디자인·수업코드 복사 동작 확인 |

---

### 2026-05-22 — 수업 코드 pill 클릭 복사 (C-260522-42)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-40.md`](../for_agent/plans/260522-40.md) |
| **한 일** | `cc-course-card__code` 버튼 — 왼쪽 Copy 아이콘 · 클릭 시 `copyCourseCode` · 카드 이동 방지 |
| **당신이 할 일** | `/app/courses`에서 코드 박스 클릭 → 클립보드·알림 확인 |

---

### 2026-05-22 — 마이페이지 프로필 UX (C-260522-41)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-40.md`](../for_agent/plans/260522-40.md) |
| **한 일** | 프로필 원형 `outline` 테두리 · 사진 있을 때 sunken 배경 · 「사진 변경」 버튼 소형화 |
| **당신이 할 일** | 흰 배경 프로필 아이콘 업로드 시 테두리·배경 구분 확인 |

---

### 2026-05-22 — 광학적 중앙 정렬 (C-260522-40)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-40.md`](../for_agent/plans/260522-40.md) |
| **한 일** | `hasSideNavLayout` · `cc-app-shell--optical` (lg+ `translateX(0.625rem)`) · Navigation·Footer·MyPage 동기 |
| **당신이 할 일** | 수업 상세·마이페이지에서 콘텐츠가 살짝 우츙 — 전체적으로 편한지 확인 |

---

### 2026-05-22 — doc 최신화 (C-260522-39)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-36.md`](../for_agent/plans/260522-36.md) |
| **한 일** | C-260522-36~38 반영 · `02`·`12`·`18`·`01`·`32` 갱신 |
| **당신이 할 일** | 아래 C-36~38 항목이 앱·`29` 표와 맞는지 확인 |

---

### 2026-05-22 — 좌측 네비 가독성·내 팀 화살표 (C-260522-38)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-36.md`](../for_agent/plans/260522-36.md) |
| **한 일** | `SideNavItem` (아이콘+라벨) · `cc-side-nav__heading` · 활성 왼쪽 강조선 · `m3-nav-item--split` 줄바꿈 수정 |
| **당신이 할 일** | 수업 상세 좌측 메뉴에서 「내 팀」과 ▼가 한 줄인지 · 아이콘·활성 색 확인 |

---

### 2026-05-22 — 수업 카드 가독성 (C-260522-37)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-36.md`](../for_agent/plans/260522-36.md) |
| **한 일** | `CourseListCard` · 학기/상태 배지 · 메타 dl(교수·시간 등) · **제목+코드 한 줄** |
| **당신이 할 일** | `/app/courses`에서 카드 제목 옆 수업 코드·구분선 읽기 편한지 확인 |

---

### 2026-05-22 — 레이아웃·푸터·로딩 UI (C-260522-36)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-36.md`](../for_agent/plans/260522-36.md) |
| **한 일** | `cc-main-viewport` (첫 화면 푸터 스크롤 후) · `PageLoading` 이중 링 스피너 · shell/`cc-page-main` 정리 · `Footer` `cc-app-shell` |
| **당신이 할 일** | 수업 목록 첫 로딩 시 푸터 안 보임 · 스크롤 후 푸터 · 로딩 애니메이션 확인 |

---

### 2026-05-22 — 좌측 네비·컬러 시스템 통일 (C-260522-35)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-35.md`](../for_agent/plans/260522-35.md) |
| **한 일** | 수업·마이페이지 사이드 `m3-nav-item` 토큰 통일 · amber/indigo Tailwind 제거 · `cc-alert-warning` 등 |
| **당신이 할 일** | 수업 좌측 메뉴·마이페이지 메뉴가 파란 활성 톤으로 맞는지 확인 |

---

### 2026-05-22 — doc 최신화 (C-260522-34)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-22.md`](../for_agent/plans/260522-22.md) |
| **한 일** | C-260522-30~33 소급 · `02`·`08`·`12`·`18` 갱신 · [`32_responsive_layout_audit.md`](./32_responsive_layout_audit.md) 신설 |
| **당신이 할 일** | 아래 C-30~33 항목이 `29` 표에 있는지 확인 |

---

### 2026-05-22 — 반응형 레이아웃 점검 (C-260522-33)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-22.md`](../for_agent/plans/260522-22.md) |
| **한 일** | 코드 기준 감사 → [`32_responsive_layout_audit.md`](./32_responsive_layout_audit.md) (Critical/Medium·브레이크포인트·체크리스트) |
| **당신이 할 일** | 375px·iPad에서 수업/팀/마이페이지 확인 · P1 수정 원하면 「반응형 P1 적용」 요청 |

---

### 2026-05-22 — 프로필 이미지 전역 연동 (C-260522-32)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-22.md`](../for_agent/plans/260522-22.md) |
| **한 일** | `ai_users.image` → `imageUrl` · `UserAvatar` · 업로드 후 `refreshProfile` · 네비·팀·수강자 네트워크 |
| **당신이 할 일** | 마이페이지에서 사진 변경 → 헤더·수강자들(본인) 동일 이미지 확인 |

---

### 2026-05-22 — 상단 네비 셸·로고 (C-260522-31)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-22.md`](../for_agent/plans/260522-22.md) |
| **한 일** | `.cc-app-shell` · `appShell.ts` · 로고 타이틀 21px · 상단=사이드+메인 가로폭 |
| **당신이 할 일** | 수업 메뉴 있는 화면에서 헤더와 아래 콘텐츠 좌우 끝 정렬 확인 |

---

### 2026-05-22 — 상단 네비 폰트 가독성 (C-260522-30)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-22.md`](../for_agent/plans/260522-22.md) |
| **한 일** | Noto Sans KR · `--cc-nav-font` · `m3-top-app-bar__nav-link` 등 · 어두운 네비(`#111827`) 대비 |
| **당신이 할 일** | 새로고침 후 「수업」·이름·로그아웃 글자 읽기 편한지 확인 |

---

### 2026-05-22 — UI 디자인 개선 1차 (C-260522-29)

| 항목 | 내용 |
|------|------|
| **계획** | [`260522-21.md`](../for_agent/plans/260522-21.md) |
| **한 일** | Linear·Notion·Stripe 패턴 조사 → [`31_design_improvement_proposal.md`](./31_design_improvement_proposal.md) 제출 · 디자인 담당 `18_product_design.md` · 토큰 CSS · 라이트 네비 · 팀 워크스페이스 PageHeader |
| **당신이 할 일** | 앱 새로고침 후 상단·팀 화면 가독성 확인 · `31` 검토 |
