...
| 로그인 버튼 파란 배경 (#61) | ✅ | T-189 | `LandingPage` `m3-btn--filled` |
| 사이드 네비 로딩 중앙 (#62) | ✅ | T-192 | `cc-page-main--with-side-nav` |
| 기본 프로필 아바타 (#63) | ✅ | T-188 | `UserAvatar` |
| 스크롤 상단 복귀 (#64) | ✅ | T-187 | `ScrollToTop` |
| 사이드 네비 sticky (#65) | ✅ | — | `AppSideNav` 기존 |
| 수업 등록 버튼 정렬 (#66) | ✅ | T-189 | `CoursesPage` |
| 새 팀 모달 중앙 (#68) | ✅ | T-191 | `AppModal` portal |
| 내 팀/팀 네비 active (#69) | ✅ | T-186 | `MainLayout` |
| 웹서비스 피드백·집계 (#70) | ✅ | T-185 | 기본 옵션 + 버튼 우측 수 |
| 팀카드 최신 활동 (#77) | ✅ | T-190 | `recordTeamActivityInDb` |
| AI 진행요약 shimmer (#79) | ✅ | T-192 | `GeminiShimmerPanel` |
| 전역 모달 portal (#80) | ✅ | T-191·T-202 | `AppModal` body portal 전역 |
| 기본 프로필 카카오 스타일 (#81) | ✅ | T-200 | `UserAvatar` · `cc-default-avatar` |
| 수업코드 등록 버튼 정렬 (#82) | ✅ | T-201 | `cc-courses-join-row` |
| 강의자료 Storage (#83) | 🔶 | T-204 · H-012 | 버킷·RLS SQL · 원격 적용 대기 |
| 교수 네비 팀참여 숨김 (#84) | ✅ | T-203 | 학생만 `MyTeamSideNavGroup` |
| 강의자료 업로드 (#60) | ❌ | — | 후속 |
| 팀카드 알림 (#67) | ❌ | — | 후속 |
| 대용량 업로드 UX (#71) | ❌ | — | 후속 |
| 산출물·TS UX (#72~#75) | ❌ | — | 후속 |
...
| 신규 추가요청 #1~#59 | 100% | 코드 반영 완료 |
| 신규 추가요청 #60~#84 | ~97% | 2026-05-23 T-185~204 · #83 원격 SQL(H-012)만 남음 |
