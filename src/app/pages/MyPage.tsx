...
import type { PeerEvaluationSummary, ProfessorProfile } from "../types";
...
export default function MyPage() {
  ...
  const professorProfile =
    user?.role === "professor" ? (user as ProfessorProfile) : null;
            ...
            <dl className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-[#e2e8f0] bg-[#f8fafc] p-4 sm:col-span-2">
                ...
                <dd className="mt-2 flex flex-wrap gap-2">
                  {professorProfile?.researchAreas && professorProfile.researchAreas.length > 0 ? (
                    professorProfile.researchAreas.map((area) => (
                      <span
                        key={area}
              ...
              <div className="rounded-lg border border-[#e2e8f0] bg-[#f8fafc] p-4 sm:col-span-2">
                ...
                <dd className="mt-2 whitespace-pre-wrap text-[14px] leading-relaxed text-[#0f172a]">
                  {professorProfile?.bio || "등록된 소개가 없습니다."}
                </dd>
              </div>
              <div className="rounded-lg border border-[#bfdbfe] bg-[#eff6ff] p-4 sm:col-span-2 shadow-sm">
                ...
                <dd className="mt-2 whitespace-pre-wrap text-[14px] leading-relaxed text-[#0f172a]">
                  {professorProfile?.teachingStyle ||
                    "충분한 피드백 데이터가 쌓이면 AI가 자동으로 분석하여 생성합니다."}
                </dd>
              </div>
              <div className="rounded-lg border border-[#e2e8f0] bg-[#f8fafc] p-4 sm:col-span-2">
                ...
                <dd className="mt-2 whitespace-pre-wrap text-[14px] leading-relaxed text-[#0f172a]">
                  {professorProfile?.studentGrowthApproach || "등록된 성장 방식이 없습니다."}
                </dd>
              </div>
            </dl>
