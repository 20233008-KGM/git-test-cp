        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-[380px]">
          ...
          <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-8">
            ...
            <button
              ...
              className="w-full mt-3 bg-gray-100 text-gray-700 py-2 rounded-lg text-xs font-medium border border-dashed border-gray-300 hover:bg-gray-200 transition-colors"
            >
              (개발용임시로그인패스)
            </button>
